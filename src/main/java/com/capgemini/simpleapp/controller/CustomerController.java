...
public class CustomerController {
	...
	public String getAuthentication(@Validated({ loginCheck.class }) @ModelAttribute Customer customer,
	...
	public String getEditProfile(@Validated({ editProfileCheck.class }) @ModelAttribute Customer customer,
	...
	public String getUpdatePassword(HttpSession session, @RequestParam("newPassword") String newPassword,
